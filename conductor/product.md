...
- Boards display a top hero section (~200px) carrying the board's background, title, description, and actions; dashboard cards use a compact version of the same hero
