...
## Goal
Initialize the full-stack project with Next.js, Express.js (with Socket.io scaffolding), PostgreSQL via Drizzle ORM, and implement user authentication (registration, login, session management) with NextAuth.js.
...
- Drizzle ORM initialized with schema definitions
